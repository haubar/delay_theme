...
function molugo_post_thumbnails() {
    ...
    add_image_size( 'single-thumb', 1000, 363 , true); // 300 pixels wide (and unlimited height)
    add_image_size( 'index-master-thumb', 576, 576 ); // 300 pixels wide (and unlimited height)
    add_image_size( 'index-slave-thumb', 417, 276 ); // 300 pixels wide (and unlimited height)
    add_image_size( 'index-center-thumb', 598, 399 ); // 300 pixels wide (and unlimited height)
    add_image_size( 'list-thumb', 326, 217 ); // 300 pixels wide (and unlimited height)
}
